...
$query = mysql_query("SELECT id_member,nama,password,gender,email,kodepos,kota,telp,level FROM member WHERE id_member='$id_member'");
$data  = mysql_fetch_array($query);
$_SESSION['b_nama']  = $data['nama'];
$_SESSION['b_id_member']  = $data['id_member'];
?>
...
<br>
    <div class="row" style="margin-top:30px;" align="left">
      <div class="small-12">
        <p><?php echo '<h3>Hi ' .$_SESSION['b_nama'].'</h3>'; ?></p>
    ...
    <form method="POST" action=index.php?pg=updateMember style="margin-top:30px;">
      
              <?php

                $result = $mysqli->query('SELECT * FROM member WHERE id_member='.$_SESSION['b_id_member']);
                ...
                if($result) {
                  ...
                  echo '<div class="form-group">
                        <input type="text" name="member_level" class="form-control" placeholder="Level:  '. $obj->level. '" maxlength="16"/>
                        </div>';
                  echo '<div class="form-group">
